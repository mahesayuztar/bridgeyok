...
export interface paths {
    ...
    "/v1/account/heartbeat": {
        ...
        get?: never;
        put?: never;
        post: operations["heartbeatAccount"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/account/users": {
        ...
        get: operations["searchAccountUsers"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/account/users/{userId}/follow": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put: operations["followAccountUser"];
        post?: never;
        delete: operations["unfollowAccountUser"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/v1/account/tables/{tableId}/participants": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["getTableAccountProfiles"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/account/tables/{tableId}/invites": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        post: operations["inviteAccountPlayer"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        AccountProfile: {
            ...
            displayName: string;
            /** @enum {string} */
            avatar: "spade" | "heart" | "diamond" | "club" | "owl" | "fox";
            online: boolean;
            following: boolean;
            friends: boolean;
            /** Format: uuid */
...
export interface operations {
    ...
    inviteAccountPlayer: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PlayerInviteRequest"];
            };
        };
        responses: {
            /** @description Successful operation */
    ...
    listPlayerInvitations: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PlayerInvitation"][];
                };
            };
            /** @description Account operation rejected */
            default: {

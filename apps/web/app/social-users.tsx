...
export function SocialUsers({ viewerId, table }: { viewerId: string; table?: { id: string; inviteCode: string; disabled: boolean } }) {
  const [query, setQuery] = useState("");
  const [friendsOnly, setFriendsOnly] = useState(!table);
